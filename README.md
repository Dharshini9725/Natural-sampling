...
![image](https://github.com/user-attachments/assets/2b5bc996-4dc2-4c69-9786-ed9be34c6702)

### RESULT:

The continuous sine wave is sampled at regular intervals, where the sampling signal multiplies the continuous signal, resulting in discrete samples. The output shows how the continuous signal is sampled at 
specified intervals. These discrete samples represent the continuous signal at the sampling times.
